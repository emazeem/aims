    ...
    <div class="col-12 font-style mt-2">
        ...
        <div class="row py-3">
            <div class="col-3 row my-1 font-11 ">
                ...
                <div class="col-9 custom-bottom-border  text-center" ><?php echo e($job->id); ?></div>
            </div>
            <div class="col-2 row my-1 font-11 ">
                <div class="col-3">Date:</div>
                <div class="col-9 custom-bottom-border  text-center" ><?php echo e(date('d m Y')); ?></div>
            </div>
            <div class="col-4 row my-1 font-11 ">
                <div class="col-7">Work order / Quotation # </div>
                <div class="col-5 custom-bottom-border  text-center" ><?php echo e($job->session_id); ?></div>
            </div>
            <div class="col-3 row my-1 font-11 ">
            ...
            <div class="col-6 row my-1 font-11 ">
                ...
                <div class="col-8 custom-bottom-border  text-center" ><?php echo e($job->quotes->customers->reg_name); ?></div>
            </div>
            <div class="col-6 row my-1 font-11 ">
                <div class="col-3">Address:</div>
                <div class="col-9 custom-bottom-border text-center" ><?php echo e($job->quotes->customers->address); ?></div>
            </div>
            <div class="col-12 row my-1 font-11 ">
                <div class="col-2">Contact Person:</div>
                <div class="col-10 custom-bottom-border text-center" ><?php echo e($job->quotes->principal); ?></div>
            </div>
            <div class="col-6 row my-1 font-11 ">
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $labjobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $labjob): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <?php $i++; ?>
                        <td class="font-11"><?php echo e(\App\Models\Item::find($labjob->item_id)->capabilities->name); ?></td>
                        <td class="font-11"><?php echo e($labjob->eq_id); ?></td>
                        <td class="font-11"><?php echo e($labjob->model); ?></td>
                        <td class="font-11"><?php echo e(date('d M-Y h:i A',strtotime($labjob->jobs->quotes->turnaround))); ?></td>
                ...
                <?php $__currentLoopData = $sitejobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sitejob): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        ...
                        <td class="font-11"><?php echo e($sitejob->model); ?></td>
                        <td class="font-11"><?php echo e(date('d M-Y h:i A',strtotime($sitejob->jobs->quotes->turnaround))); ?></td>
                ...
                <tr>
                    <td class="font-11">
                        <div class="row py-3">
                            ...
                            <div class="col-8 text-center custom-bottom-border px-5">
                                <span class="text-right"><?php echo e(auth()->user()->fname); ?> <?php echo e(auth()->user()->lname); ?></span>
                            </div>
                            <div class="col-3">
                                Date
                            </div>
                            <div class="col-8 text-center custom-bottom-border px-5">
                                <span class="text-right"><?php echo e(date('d-m-Y')); ?></span>
                            </div>
                    ...
                    <td class="font-11">
                        <div class="row py-3">
                            ...
                            <div class="col-8 text-center custom-bottom-border px-5">
                                <span class="text-right "><?php echo e($job->quotes->principal); ?></span>
                            </div>
                            <div class="col-3">
                                Date
                            </div>
...
</html><?php /**PATH C:\xampp\htdocs\aims\resources\views/jobs/jobform.blade.php ENDPATH**/ ?>