            ...
            <form class="form-horizontal" action="<?php echo e(route('roles.store')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group mt-md-4 row">
                    <label for="name" class="control-label col-12">Title
                        <input type="text" class="form-control col-12" id="name" name="name" placeholder="Title for Role"   value="<?php echo e(old('name')); ?>">
                    </label>
                    ...
                    <ul style="list-style:none">
                        <?php $__currentLoopData = $menuus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $menu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($menu->parent_id==null): ?>
                                <div class="checkbox">
                                    <label class="custom-label"><input type="checkbox" value="<?php echo e($menu->slug); ?>" name="menu_arr[]"><i class="fa fa-bars text-info ml-3"></i> <?php echo e($menu->name); ?></label>
                                </div>
                                <?php $__currentLoopData = $menu->parent; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <label class="custom-label"><input type="checkbox" value="<?php echo e($item->slug); ?>" name="menu_arr[]"><i class="fa fa-lock text-danger ml-3"></i> <?php echo e($item->name); ?></label>
                                </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/roles/create.blade.php ENDPATH**/ ?>