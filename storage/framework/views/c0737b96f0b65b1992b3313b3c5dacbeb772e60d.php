...
<head>
    ...
    <title>AIMS-QT-<?php echo e(date('y')); ?>-<?php echo e($session->id); ?> <?php echo e($session->customers->reg_name); ?></title>
    ...
    <div class="col-12 font-style mt-2">
        ...
        <div class="row">
            <div class="col-2 text-center custom-border">
                <img src="<?php echo e(url('/img/AIMS.png')); ?>" width="150" class="img-fluid p-1">
            </div>
        ...
        <div class="row">
            <table class="table table-bordered">
                ...
                <tr>
                    <td class="font-11"><?php echo e($session->principal); ?></td>
                    <td class="font-11"></td>
                    <td class="font-11"><?php echo e($session->users->fname); ?> <?php echo e($session->users->lname); ?></td>
                    <td class="font-11"></td>
                    <td class="font-11"><?php echo e(auth()->user()->fname); ?> <?php echo e(auth()->user()->lname); ?></td>
                    <td class="font-11"></td>
            ...
            <div class="col-10  font-10 custom-bottom-border"><p class="col-8  p-0 m-0 float-left"><?php echo e($session->customers->reg_name); ?></p><p class="col-1 p-0 m-0 float-left">Attention;</p><p class="col-3 p-0 m-0 text-right float-left"><?php echo e($session->principal); ?></p></div>
            <div class="col-2 font-10 ">Address:</div>
            <div class="col-10 font-10  custom-bottom-border"><?php echo e($session->customers->address); ?></div>
            <div class="col-2 font-10 ">Phone:</div>
            <div class="col-10  font-10 custom-bottom-border">
                <?php if($session->principal==$session->customers->prin_name_1): ?>
                    <?php echo e($session->customers->prin_phone_1); ?>

                <?php elseif($session->principal==$session->customers->prin_name_2): ?>
                    <?php echo e($session->customers->prin_phone_2); ?>

                <?php else: ?>
                    <?php echo e($session->customers->prin_phone_3); ?>
            ...
            <div class="col-10  font-10 custom-bottom-border">
                <?php if($session->principal==$session->customers->prin_name_1): ?>
                    <?php echo e($session->customers->prin_email_1); ?>

                <?php elseif($session->principal==$session->customers->prin_name_2): ?>
                    <?php echo e($session->customers->prin_email_2); ?>

                <?php else: ?>
                    <?php echo e($session->customers->prin_email_3); ?>
            ...
            <div class="col-10  font-10 custom-bottom-border"><?php echo e(auth()->user()->fname); ?> <?php echo e(auth()->user()->lname); ?></div>
            <div class="col-2 font-10 ">Phone:</div>
            <div class="col-10 font-10  custom-bottom-border"><?php echo e(auth()->user()->phone); ?></div>
            <div class="col-2 font-10 ">Quote#:</div>
            <div class="col-10 font-10  custom-bottom-border"><?php echo e(auth()->user()->id); ?></div>
            ...
            <div class="col-12 mt-3 font-10">Dear <?php echo e($session->principal); ?>,</div>
        ...
        <div class="row">
            ...
            <p class="font-10 line-height col-7"><span class="ml-5 pl-2">2.1 - AIMS Calibration Lab in Lahore</span>.<input type="checkbox" <?php echo e(($type=="LAB")?"checked":""); ?> class="float-right"></p>

            <div class="col-12"></div>
            <p class="font-10 line-height col-7"><span class="ml-5 pl-2">2.2 - Customer premises as per given address.</span><input type="checkbox" <?php echo e(($type=="SITE")?"checked":""); ?> class="float-right"></p>
            <div class="col-12"></div>

            <p class="font-10 line-height col-7"><span class="ml-5 pl-2">2.3 - Partially at site and partially in AIMS Lab.</span><input type="checkbox" <?php echo e(($type=="SPLIT")?"checked":""); ?> class="float-right"></p>
            <div class="col-12"></div>
        ...
        <div class="row ">
            ...
            <p class="font-12 text-right col-12 b float-right">Date : <span class="custom-bottom-border"><?php echo e(date('d-m-Y',time())); ?></span></p>
        </div>
        <div class="row py-3">
        ...
        <div class="row py-3">
            ...
            <table class="table table-bordered">
                ...
                <?php $__currentLoopData = $session->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quote): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>

                        <td class="font-11"><?php echo e($i); ?></td>
                        <td class="font-11">

                            <?php if($quote->not_available): ?>
                                <?php echo e($quote->not_available); ?>

                            <?php else: ?>
                                <?php echo e($quote->capabilities->name); ?></td>
                            <?php endif; ?>
                        ...
                        <td class="font-11">
                            <?php if($quote->not_available): ?>
                                ---
                            <?php else: ?>
                                <?php echo e($quote->parameters->name); ?>

                            <?php endif; ?>

                        </td>
                        <td class="font-11"><?php echo e($quote->range); ?></td>
                        <td class="font-11"><?php echo e($quote->accredited); ?></td>
                        <td class="font-11"><?php echo e($quote->location); ?></td>
                        <td class="font-11"><?php echo e($quote->price); ?></td>
                        <td class="font-11"><?php echo e($quote->quantity); ?></td>
                        <td class="font-11"><?php echo e($quote->quantity*$quote->price); ?></td>
                    </tr>
                    <?php $i++;$subtotal=$subtotal+($quote->quantity*$quote->price); ?>

                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                <tr>
                    <th colspan="8">Total Service Charges</th>
                    <th colspan="2"><?php echo e($subtotal); ?></th>
                </tr>
                <tr>
                    <th colspan="8">Punjab Revenue Authority Tax  (<?php echo e($session->customers->region); ?>)</th>
                    <th colspan="2">
                        <?php if($session->customers->region="PRA"): ?>
                            16% <?php $tax=16/100; ?>
                        <?php elseif($session->customers->region="SRB"): ?>
                            13% <?php $tax=13/100; ?>
                        <?php elseif($session->customers->region="KPRA"): ?>
                            15% <?php $tax=15/100; ?>
                        <?php elseif($session->customers->region="BRA"): ?>
                            15% <?php $tax=15/100; ?>
                        <?php elseif($session->customers->region="IRD"): ?>
                            16% <?php $tax=16/100; ?>
                        <?php endif; ?>
                    </th>
                </tr>
                <tr>
                    ...
                    <th colspan="8"  class="text-capitalize">Total ( <?php echo e(NumConvert::word($total)); ?> )</th>
                    <th colspan="2"><?php echo e(($subtotal*$tax)+$subtotal); ?></th>
                </tr>
                </tbody>
            </table>
            ...
            <div class="ml-5">
                ...
                <p class="ml-5 font-10 col-12 pl-2"><input type="checkbox" <?php echo e(($session->customers->customer_type=="cash" and $session->customers->pay_terms=="advance")?"checked":""); ?>> Cash/cheque advance  before starting job.</p>
                <p class="ml-5 font-10 col-12 pl-2"><input type="checkbox" <?php echo e(($session->customers->customer_type=="cash" and $session->customers->pay_terms=="against delivery")?"checked":""); ?>> Cash/cheque against delivery of calibration certificates.</p>

                <p class="ml-5 col-12 font-10 pl-2"><input type="checkbox" <?php echo e(($session->customers->customer_type=="credit" and $session->customers->pay_terms=="15 days")?"checked":""); ?>> 15 days from invoice date.</p>
                <p class="ml-5 col-12 font-10 pl-2"><input type="checkbox" <?php echo e(($session->customers->customer_type=="credit" and $session->customers->pay_terms=="30 days")?"checked":""); ?>> 30 days from invoice date.</p>
                <p class="ml-5 col-12 font-10 pl-2"><input type="checkbox" <?php echo e(($session->customers->customer_type=="credit" and $session->customers->pay_terms=="60 days")?"checked":""); ?>> 60 days from invoice date.</p>
                <p class="ml-5 col-12 font-10 pl-2"><input type="checkbox" <?php echo e(($session->customers->customer_type=="credit" and $session->customers->pay_terms=="120 days")?"checked":""); ?>> 120 days from invoice date.</p>
            ...
            <div class="col-7 ">
                ...
                <p class="font-11 line-height col-12 b "><span class="custom-bottom-border">Date :  <?php echo e(date('d-m-Y',time())); ?></span></p>
            </div>
            <div class="col-4 mb-5 text-right">
                <img src="<?php echo e(url('/img/AIMS.png')); ?>" width="150" class="img-fluid ">
            </div>
        </div>
    </div>
</div>
</body>
</html><?php /**PATH C:\xampp\htdocs\aims\resources\views/quotes/print.blade.php ENDPATH**/ ?>