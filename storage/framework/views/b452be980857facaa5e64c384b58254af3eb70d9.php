...
<?php $__env->startSection('content'); ?>
    <div class="row">
        ...
        <div class="col-12 mb-4">
            ...
            <a href="<?php echo e(route('parameters')); ?>" class="btn float-right mx-1 btn-sm btn-success shadow-sm"><i class="fas fa-eye"></i> Parameters</a>
        </div>
...
<script>
    ...
    function InitTable() {
        ...
        $('#example').DataTable({
            ...
            "pageLength": 25,
            "ajax":{
                "url": "<?php echo e(route('capabilities.fetch')); ?>",
                "dataType": "json",
                "type": "POST",
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function() {
            var id = $(this).attr('data-id');
                $.ajax({
                    "url": "<?php echo e(url('/capabilities/edit')); ?>",
                    type: "POST",
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            url: "<?php echo e(route('capabilities.delete')); ?>",
                            type: request_method,
                            dataType: "JSON",
                            data: form_data,
                            statusCode: {
        ...
        $("#add_capabilities_form").on('submit',(function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "<?php echo e(route('capabilities.store')); ?>",
                type: "POST",
        ...
        $("#edit_capabilities_form").on('submit',(function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "<?php echo e(route('capabilities.update')); ?>",
                type: "POST",
                data:  new FormData(this),
                contentType: false,
                cache: false,
                ...
                <div class="modal-body">
                    <form id="edit_capabilities_form">
                        ...
                        <div class="form-group mt-md-4 row">
                            <label for="name" class="col-sm-2 control-label">Name</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="editname" name="name" placeholder="Name" autocomplete="off" value="<?php echo e(old('name')); ?>">
                                <?php if($errors->has('name')): ?>
                                    <span class="text-danger">
                          <strong><?php echo e($errors->first('name')); ?></strong>
                      </span>
                        ...
                        <div class="form-group mt-md-4 row">
                            <label for="range" class="col-sm-2 control-label">Range</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="editrange" name="range" placeholder="Range" autocomplete="off" value="<?php echo e(old('range')); ?>">
                                <?php if($errors->has('range')): ?>
                                    <span class="text-danger">
                          <strong><?php echo e($errors->first('range')); ?></strong>
                      </span>
                        ...
                        <div class="form-group mt-md-4 row">
                            <label for="accuracy" class="col-sm-2 control-label">Accuracy</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="editaccuracy" name="accuracy" placeholder="Accuracy" autocomplete="off" value="<?php echo e(old('accuracy')); ?>">
                                <?php if($errors->has('accuracy')): ?>
                                    <span class="text-danger">
                          <strong><?php echo e($errors->first('accuracy')); ?></strong>
                      </span>
                        ...
                        <div class="form-group mt-md-4 row">
                            <label for="price" class="col-sm-2 control-label">Price</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="editprice" name="price" placeholder="Price" autocomplete="off" value="<?php echo e(old('price')); ?>">
                                <?php if($errors->has('price')): ?>
                                    <span class="text-danger">
                          <strong><?php echo e($errors->first('price')); ?></strong>
                      </span>
                        ...
                        <div class="form-group mt-md-4 row">
                            <label for="remarks" class="col-sm-2 control-label">Remarks</label>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="editremarks" name="remarks" placeholder="Remarks" autocomplete="off" value="<?php echo e(old('remarks')); ?>">
                                <?php if($errors->has('remarks')): ?>
                                    <span class="text-danger">
                          <strong><?php echo e($errors->first('remarks')); ?></strong>
                      </span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/capabilities/index.blade.php ENDPATH**/ ?>