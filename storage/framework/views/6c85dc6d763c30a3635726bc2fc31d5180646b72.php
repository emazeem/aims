...
<div class="container  my-5">
    <div class="row">
        ...
        <div class="col-12 text-right">
            Date of Issue :
            <span class="custom-bottom-border"><?php echo e(date('d-M-Y',strtotime($entries->created_at))); ?></span>
        </div>
        <div class="col-12 text-right">
        ...
        <div class="row col-12 p-0">
            ...
            <div class="col-10 font-weight-bold"><?php echo e($mainjob->quotes->customers->reg_name); ?></div>
            <div class="col-2 font-weight-bold">Address :</div>
            <div class="col-10"><?php echo e($mainjob->quotes->customers->address); ?></div>
            <div class="col-2 font-weight-bold">Request #:</div>
            <div class="col-10"><?php echo e($mainjob->quotes->details); ?></div>
            <div class="col-2 font-weight-bold">Job #:</div>
            <div class="col-10"><?php echo e($mainjob->id); ?></div>
        </div>
        ...
        <div class="row col-12 p-0">
            ...
            <div class="col-2 font-weight-bold"><?php echo e(date('d-M-Y',strtotime($entries->created_at))); ?></div>
            ...
            <div class="col-10"  style="margin-top: -10px"><?php echo e($entries->location); ?></div>
        </div>
        <table class="table table-bordered text-center mt-2">
            ...
            <tr>
                <td class="py-3"><?php echo e($job->items->capabilities->name); ?></td>
                <td class="py-3"><?php echo e($job->make); ?></td>
                <td class="py-3"><?php echo e($job->model); ?></td>
                <td class="py-3"><?php echo e($job->serial); ?></td>
                <td class="py-3"><?php echo e($job->eq_id); ?></td>
                <td class="py-3"><?php echo e($job->accuracy); ?></td>
    ...
    <div class="row">
        ...
        <div class="col-3"><?php echo e($job->items->capabilities->procedures->name); ?></div>
        ...
        <table class="table table-bordered text-center">
            ...
            <tr>
                ...
                <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <td class="py-3"><?php echo e(\App\Models\Asset::find($asset)->name); ?></td>
                        <td class="py-3"><?php echo e(\App\Models\Asset::find($asset)->make); ?></td>
                        <td class="py-3"><?php echo e(\App\Models\Asset::find($asset)->model); ?></td>
                        <td class="py-3"><?php echo e(\App\Models\Asset::find($asset)->code); ?></td>
                        <td class="py-3">-</td>
                        <td class="py-3"><?php echo e(\App\Models\Asset::find($asset)->traceability); ?></td>
    ...
    <div class="row">
        <h6 class=" custom-bottom-border col-12 p-0 m-0 mb-3 font-weight-bold">Measurement Data for Humidity</h6>
            ...
            <div class="col-9"> <?php echo e($job->range); ?></div>
            <div class="col-3 font-weight-bold">Resolution : </div>
            <div class="col-9"><?php echo e($job->resolution); ?></div>
        </div>
        ...
        <table class="table table-bordered text-center">
            <tr>
                <td width="25%">
                    ...
                    <br>X
                    <br>( <?php echo e(\App\Models\Unit::find($entries->unit)->unit); ?> )
                </td>
                <td width="25%">
            ...
            <?php $__currentLoopData = $entries->child; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                    <td>
                        <?php if($entries->fixed_type=='UUC'): ?>
                            <?php echo e($item->fixed_value); ?>
                    ...
                    <td><?php echo e($uuc-$reference); ?></td>
                    <td>-</td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table>
    ...
    <div class="col-10 text-right mt-4">
        Calibrated By: 			<?php echo e(\App\Models\User::find($entries->calibrated_by)->fname .' '. \App\Models\User::find($entries->calibrated_by)->lname); ?>
...
</html><?php /**PATH C:\xampp\htdocs\aims\resources\views/mytask/certificate.blade.php ENDPATH**/ ?>