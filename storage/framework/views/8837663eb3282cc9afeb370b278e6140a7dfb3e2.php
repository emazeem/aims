...
<?php $__env->startSection('content'); ?>
                ...
                <div class="form-group mt-md-4 row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name"
                               autocomplete="off" value="<?php echo e(old('name',$edit->name)); ?>">
                ...
                <div class="form-group mt-md-4 row">
                    ...
                    <div class="col-10">
                        <input type="text" class="form-control" id="description" name="description" placeholder="Short Description of Procedure"
                               autocomplete="off" value="<?php echo e(old('description',$edit->description)); ?>">
                        ...
                        <tr>
                            <td class="text-center">
                                <div class="checkbox mt-2">
                                    <input type="checkbox" id="<?php echo e($uncertainty->slug); ?>" value="<?php echo e($uncertainty->slug); ?>" name="uncertainties[]" <?php echo e((in_array($uncertainty->slug,explode(',',$edit->uncertainties)))?'checked':''); ?>>
                                </div>
                            </td>
                            <td>
    ...
    <script>
        $("#edit_procedure_form").on('submit',(function(e) {

            e.preventDefault();
            $.ajax({
                url: "<?php echo e(route('procedures.update')); ?>",
                type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/procedures/edit.blade.php ENDPATH**/ ?>