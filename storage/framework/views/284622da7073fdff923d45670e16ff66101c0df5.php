...
<div class="container">
    ...
    <div class="row py-3">
        <div class="col-3 row my-1 font-11 ">
            ...
            <div class="col-9 custom-bottom-border  text-center" ><?php echo e($quotes->id); ?></div>
        </div>
        <div class="col-4 row my-1 font-11 ">
            <div class="col-5">Inquiry Date:</div>
            <div class="col-7 custom-bottom-border  text-center" ><?php echo e(date('d-m-y',strtotime($quotes->created_at))); ?></div>
        </div>
        ...
        <div class="col-6 row my-1 font-11 ">
            ...
            <div class="col-9 custom-bottom-border  text-center" ><?php echo e($quotes->customers->reg_name); ?></div>
        </div>
        <div class="col-6 row my-1 font-11 ">
            <div class="col-2"> Email : </div>
            <div class="col-10 custom-bottom-border  text-center" >
                <?php if($quotes->principal==$quotes->customers->prin_name_1): ?>
                    <?php echo e($quotes->customers->prin_email_1); ?>

                <?php elseif($quotes->principal==$quotes->customers->prin_name_2): ?>
                    <?php echo e($quotes->customers->prin_email_2); ?>

                <?php else: ?>
                    <?php echo e($quotes->customers->prin_email_3); ?>
    ...
    <div class="row custom-border">
        ...
        <?php $__currentLoopData = $listed; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="font-11 col-12"><li><?php echo e($list->not_available); ?></li></div>
    ...
    <div class="row custom-border mt-3">
        ...
        <?php $__currentLoopData = $nonlisted; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="font-11 col-12"><li><?php echo e($list->not_available); ?></li></div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="row mt-3">
        <div class="col-4 py-2 custom-border border-right-0">
            ...
            <div class="custom-bottom-border ">
                <?php echo e(date('d-m-y',strtotime($quotes->created_at))); ?>
...
</html><?php /**PATH C:\xampp\htdocs\aims\resources\views/quotes/review.blade.php ENDPATH**/ ?>