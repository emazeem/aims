...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h2 class="border-bottom text-dark">All Menus</h2>
    <div>
    <a href="<?php echo e(route('menus.manage')); ?>" class="btn btn-sm pull-right btn-success shadow-sm"><i class="fas fa-sort"></i> Manage Menus</a>
...
<script>
    ...
    function InitTable() {
        ...
        $('#example').DataTable({
            ...
            "pageLength": 25,
            "ajax":{
                "url": "<?php echo e(route('menus.fetch')); ?>",
                "dataType": "json",
                "type": "POST",
    ...
    $(document).ready(function() {
        ...
        $("#add_menu_form").on('submit',(function(e) {
            ...
            e.preventDefault();
            $.ajax({
                url: "<?php echo e(route('menus.store')); ?>",
                type: "POST",
        ...
        $("#edit_menu_form").on('submit',(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?php echo e(route('menus.update')); ?>",
                type: "POST",
                data:  new FormData(this),
                contentType: false,
                cache: false,
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        $.ajax({
                            url: "<?php echo e(url('menus/delete')); ?>",
                            type: request_method,
                            dataType: "JSON",
                            data: form_data,
                            statusCode: {
            ...
            <div class="modal-body">
                <form id="add_menu_form">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-12">
                            <input type="text" class="form-control" id="slug" name="slug" placeholder="Slug" autocomplete="off" value="<?php echo e(old('slug')); ?>">
                        </div>
                        <div class="form-group col-12">
                        ...
                        <div class="form-group col-12">
                            <input type="text" class="form-control" id="icon" name="icon" placeholder="icon" autocomplete="off" value="<?php echo e(old('icon')); ?>">
                        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="edit_menu_form">
                    ...
                    <div class="row">
                        <div class="form-group col-12">
                            <input type="text" class="form-control" id="edit_name" name="name" placeholder="Name" autocomplete="off" value="<?php echo e(old('name')); ?>">
                        </div>
                        <div class="form-group col-12">
                            <input type="text" class="form-control" id="edit_slug" name="slug" placeholder="Slug" autocomplete="off" value="<?php echo e(old('slug')); ?>">
                        </div>
                        <div class="form-group col-12">
                            <input type="text" class="form-control" id="edit_url" name="url" placeholder="url" autocomplete="off" value="<?php echo e(old('url')); ?>">
                        </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/menus.blade.php ENDPATH**/ ?>