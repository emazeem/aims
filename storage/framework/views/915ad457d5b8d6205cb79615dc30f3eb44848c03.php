...
<?php $__env->startSection('content'); ?>
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">Edit Error & Uncertainty</h1>
    </div>
        ...
        <div class="col-12">
            ...
            <form class="form-horizontal" action="<?php echo e(route('manageref.store')); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <select class="form-control" id="assets" name="assets" >
                            <option value="<?php echo e($edit->asset); ?>" selected><?php echo e(\App\Models\Asset::find($edit->asset)->name); ?></option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-10">
                        <select class="form-control" id="units" name="units" >
                            <option value="<?php echo e($edit->unit); ?>" selected><?php echo e(\App\Models\Unit::find($edit->unit)->unit); ?></option>
                        </select>
                ...
                <table id="myTable" class=" table order-list">
                    ...
                    <tbody>
                    <?php $__currentLoopData = $multiples; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $multiple): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            <td>

                                <input type="text" name="uuc[]"  class="form-control" value="<?php echo e($multiple->uuc); ?>"/>

                            </td>
                            <td>
                                <input type="text" name="reference[]"  class="form-control" value="<?php echo e($multiple->ref); ?>"/>
                            ...
                            <td>
                                <input type="text" name="uncertainty[]"  class="form-control " value="<?php echo e($multiple->uncertainty); ?>"/>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/reference_errors/edit.blade.php ENDPATH**/ ?>