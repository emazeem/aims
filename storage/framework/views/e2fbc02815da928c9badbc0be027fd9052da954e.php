...
<?php $__env->startSection('content'); ?>
    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal" action="<?php echo e(route('units.update')); ?>" method="post">
            <?php echo csrf_field(); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" class="form-control text-xs" id="unit" name="unit" placeholder="Unit" autocomplete="off" value="<?php echo e(old('unit',$edit->unit)); ?>" require >
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/units/edit.blade.php ENDPATH**/ ?>