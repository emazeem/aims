...
<script>
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                "url": "<?php echo e(url('/quotes/edit')); ?>",
                type: "POST",
        ...
        $("#add_session_form").on('submit',(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?php echo e(route('quotes.store')); ?>",
                type: "POST",
        ...
        $("#edit_session_form").on('submit',(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?php echo e(route('quotes.update')); ?>",
                type: "POST",
                data:  new FormData(this),
                contentType: false,
                cache: false,
                            ...
                            <div class="form-check form-check-inline" style="width: 100%">
                                <select class="form-control col-12" id="tm" name="tm">
                                    <?php $__currentLoopData = $tms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <option value="<?php echo e($tm->id); ?>"><?php echo e($tm->fname); ?> <?php echo e($tm->lname); ?></option>
...
<script>
    ...
    $('select[name="customer"]').on('change', function() {
        ...
        if(customer) {
            $.ajax({
                url: "<?php echo e(url('/quotes/get_principal')); ?>/"+customer,
                type: "GET",
                dataType: "json",
                success:function(data) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/quotes/index.blade.php ENDPATH**/ ?>