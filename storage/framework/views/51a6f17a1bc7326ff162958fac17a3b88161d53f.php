...
<script>
    ...
    function InitTable() {
        ...
        $('#example').DataTable({
            ...
            "pageLength": 25,
            "ajax":{
                "url": "<?php echo e(route('parameters.fetch')); ?>",
                "dataType": "json",
                "type": "POST",
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                "url": "<?php echo e(url('/parameters/edit')); ?>",
                type: "POST",
        ...
        $(document).on('click', '.view-capabilities', function() {
            ...
            $.ajax({
                "url": "<?php echo e(url('/parameters/view_capabilities')); ?>",
                type: "POST",
                data: {'id': id,_token: '<?php echo e(csrf_token()); ?>'},
                dataType : "json",
                beforeSend : function()
        ...
        $("#edit_parameter_form").on('submit',(function(e) {
            e.preventDefault();
            $.ajax({
                url: "<?php echo e(route('parameters.update')); ?>",
                type: "POST",
                data:  new FormData(this),
                contentType: false,
                cache: false,
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/parameter.blade.php ENDPATH**/ ?>