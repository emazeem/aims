...
<script>
    ...
    function InitTable() {
        ...
        $('#example').DataTable({
            ...
            "pageLength": 25,
            "ajax":{
                "url": "<?php echo e(route('columns.fetch')); ?>",
                "dataType": "json",
                "type": "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/column.blade.php ENDPATH**/ ?>