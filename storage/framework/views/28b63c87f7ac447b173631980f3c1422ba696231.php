...
<?php $__env->startSection('content'); ?>
    ...
    <h2 class="border-bottom text-dark">Add Asset Groups</h2>
    <form action="<?php echo e(route('assets.groups.store')); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="row">
                ...
                <div class="form-check form-check-inline col-12" style="width:100%;">
                    <select class="form-control" multiple id="assets" name="assets[]" style="width:100%;">
                        <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($asset->id); ?>"><?php echo e($asset->code); ?>-<?php echo e($asset->name); ?>-<?php echo e($asset->range); ?>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/assets_groups/create.blade.php ENDPATH**/ ?>