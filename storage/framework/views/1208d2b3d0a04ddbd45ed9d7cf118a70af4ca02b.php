                ...
                <tbody>
                    <?php $__currentLoopData = $jobs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $job): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr>
                            ...
                            <td>
                                <?php if($job->status==1): ?>
                                <a href="<?php echo e(route('tasks.create',[$job->id])); ?>" class="btn btn-info btn-sm"><i class="fa fa-user-plus"></i></a>
                                <?php elseif($job->status==2): ?>
                                    <a href="<?php echo e(route('tasks.edit',[$job->id])); ?>" class="btn btn-success btn-sm"><i class="fa fa-user-edit"></i></a>
                                <?php endif; ?>
                            </td>
                        </tr>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/scheduling/labjob.blade.php ENDPATH**/ ?>