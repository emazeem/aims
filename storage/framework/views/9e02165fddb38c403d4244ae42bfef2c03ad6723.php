        ...
        <div class="col-md-5 col-12 mb-5 mt-4">
            <div class="card bg-transparent mt-md-5 mt-4" style="border-radius: 0">
                <div class="card-header py-md-3 text-center" style="background-color: rgba(255,255,255,0.5)">
                    <img src="<?php echo e(asset('img/AIMS.png')); ?>" class="img-fluid" width="100">
                </div>
                <div class="card-body" style="background-color: rgba(255,255,255,0.2)">
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="form-group row mt-5">
                            <label for="email" class="col-md-3 text-light col-form-label text-md-right"><?php echo e(__('E-Mail')); ?></label>
                            <div class="col-md-8">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-3 text-light col-form-label text-md-right"><?php echo e(__('Password')); ?></label>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/auth/login.blade.php ENDPATH**/ ?>