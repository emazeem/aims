    ...
    <script>
        ...
        function InitTable() {
            ...
            $('#example').DataTable({
                ...
                "pageLength": 25,
                "ajax":{
                    "url": "<?php echo e(route('scheduling.fetch')); ?>",
                    "dataType": "json",
                    "type": "POST",
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-horizontal" action="<?php echo e(route('tasks.siteassignjobs')); ?>" method="post">
                        <?php echo csrf_field(); ?>
                                ...
                                <div class="form-check form-check-inline" >
                                    <select class="form-control" multiple id="assets" name="assets[]" style="width: 385px;">
                                        ...
                                        <?php $__currentLoopData = $assets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $asset): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($asset->id); ?>"><?php echo e($asset->code); ?>-<?php echo e($asset->name); ?>-<?php echo e($asset->range); ?>-<?php echo e($asset->resolution); ?>-<?php echo e($asset->accuracy); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/scheduling/index.blade.php ENDPATH**/ ?>