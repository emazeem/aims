...
<script>
    ...
    function InitTable() {
        ...
        $('#example').DataTable({
            ...
            "pageLength": 25,
            "ajax":{
                "url": "<?php echo e(route('departments.fetch')); ?>",
                "dataType": "json",
                "type": "POST",
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', '.edit', function() {
            ...
            $.ajax({
                "url": "<?php echo e(url('/departments/edit')); ?>",
                type: "POST",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\aims\resources\views/department.blade.php ENDPATH**/ ?>