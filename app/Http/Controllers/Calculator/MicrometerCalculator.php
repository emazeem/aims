...
use App\Models\MicrometerEntries;
use App\Models\Preference;
use App\Models\Procedure;
use App\Models\Unit;
use Illuminate\Http\Request;

class MicrometerCalculator extends Controller
{
    public function create($id){
        ...
        return view('calculator.micrometer.create',compact('id','labs','parent','assets','units'));
    }
    public function store(Request $request){
        ...
        $allentries=MicrometerEntries::where('parent_id',$entries->id)->get();
