    ...
    <div class="col-12">
        <div class="col-12">
            ...
            <button type="button" class="btn btn-sm btn-primary shadow-sm pull-right mt-2" data-toggle="modal"
                    data-target="#inventory_categories"><i class="fa fa-plus-circle"></i> Inventory Categories
            </button>
        </div>
                    ...
                    <form action="{{route('inventory.category.store')}}" class="form" id="add_form" method="POST">
                        ...
                        <div class="modal-body" id="modalbody">
                            ...
                            <div class="form-group">
                                ...
                                <select type="text" name="parent" id="edit_parent" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="edit_category_name" name="category_name"
                                       placeholder="Category Name" autocomplete="off" value="{{ old('category_name') }}">
                                <span class="text-red">
