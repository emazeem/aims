                    ...
                    <tr>
                        ...
                        <td>
                            @foreach($assets as $asset)
                                <small class="badge badge-pill badge-danger">{{\App\Models\Asset::find($asset)->name}} <b>( {{\App\Models\Asset::find($asset)->code}} )</b></small>
                                <br>
                            @endforeach
                        </td>
                        <td>
                    ...
                    <form id="add_suggestion_form" method="post" action="{{url('suggestions/create')}}">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-12">
                                <input class="form-control " type="hidden" id="capability" name="capability" placeholder="capability" value="{{$show->id}}" autocomplete="off"/>                                   <input class="form-control " placeholder="capability" value="{{$show->name}}" autocomplete="off" readonly/>
                            </div>
                        </div>
                        <div class="row">
