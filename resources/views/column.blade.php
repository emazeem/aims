...
<div class="row">
    <div class="col-12">
        <h3 class="border-bottom text-dark pull-left"><i class="fa fa-tasks"></i> All Columns</h3>
        <button type="button" class="btn btn-sm btn-primary shadow-sm pull-right" data-toggle="modal" data-target="#add_column"><i class="fa fa-plus"></i> Add Specific Column</button>
    </div>
  <div class="col-lg-12">
