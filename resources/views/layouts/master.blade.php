...
or Route::currentRouteName()=='inventory.category.index' or Route::currentRouteName()=='inventory.index' or Route::currentRouteName()=='business.line' or Route::currentRouteName()=='purchase.invoice'  or Route::currentRouteName()=='journal.vouchers' or Route::currentRouteName()=='sales.invoice.create')
