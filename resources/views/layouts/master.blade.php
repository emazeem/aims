...
or Route::currentRouteName()=='acc_level_two'or Route::currentRouteName()=='acc_level_three'or Route::currentRouteName()=='acc_level_four'or Route::currentRouteName()=='vouchers' or Route::currentRouteName()=='sales.vouchers'  or Route::currentRouteName()=='sales.receipt.vouchers'or Route::currentRouteName()=='journal.index' or Route::currentRouteName()=='generaterequests'
