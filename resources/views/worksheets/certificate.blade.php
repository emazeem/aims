...
<div class="container  my-5">
    <div class="row">
        ...
        <div class="col-12 text-right">
            Date of Issue :
            <span class="custom-bottom-border">15-Apr-2020</span>
        </div>
        <div class="col-12 text-right">
        ...
        <div class="row col-12 p-0">
            ...
            <div class="col-10 font-weight-bold">Pacific Pharmaceuticals (Pvt.) Ltd</div>
            <div class="col-2 font-weight-bold">Address :</div>
            <div class="col-10">30 Km Multan Road, Lahore.</div>
            <div class="col-2 font-weight-bold">Request #:</div>
            <div class="col-10">Verbal</div>
            <div class="col-2 font-weight-bold">Job #:</div>
            <div class="col-10">JN/20/0417</div>
        </div>
        ...
        <div class="row col-12 p-0">
            ...
            <div class="col-2 font-weight-bold">14-Apr-2020</div>
            ...
            <div class="col-10"  style="margin-top: -10px">Dry Mix Area</div>
        </div>
        <table class="table table-bordered text-center mt-2">
            ...
            <tr>
                <td class="py-3">Thermohygrometer</td>
                <td class="py-3">China</td>
                <td class="py-3">HTC-1</td>
                <td class="py-3">--</td>
                <td class="py-3">QCHM-22</td>
                <td class="py-3">--</td>
            </tr>
        </table>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-3">Euramet cg-18 & OIML R 76</div>
    ...
    <div class="row">
        ...
        <table class="table table-bordered text-center">
            ...
            <tr>
                <td class="py-3">Digital Thermohygrometer</td>
                <td class="py-3">TFA Germany</td>
                <td class="py-3">20.5011.V2</td>
                <td class="py-3">T-072</td>
                <td class="py-3">PSC/SRF/10TH/0903-1</td>
                <td class="py-3">DCL Dubai</td>
            </tr>
        </table>
    </div>
    <div class="row">
    ...
    <div class="row">
        ...
        <div class="row p-0 m-0">
            ...
            <div class="col-9"> 40		%RH		to	70		%RH</div>
            <div class="col-3 font-weight-bold">Resolution : </div>
            <div class="col-9">1		%RH</div>
        </div>
    ...
    <div class="row">
        <h6 class=" custom-bottom-border col-12 p-0 m-0 mb-3 font-weight-bold">
            Measurement Data for Temperature:
        </h6>
    </div>
    <div class="row col-12">
        <div class="col-3 font-weight-bold">Calibrated Range :</div>
        <div class="col-9"> 20		C		to	30	C</div>
        <div class="col-3 font-weight-bold">Resolution : </div>
        <div class="col-9">0.1 C</div>
    </div>
    <div class="row mt-2">
        <table class="table table-bordered text-center">
            <tr >
