    ...
    <div class="box box-info">
        ...
        <form class="form-horizontal" action="{{route('intermediate-checks.update')}}" method="post">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <div class="form-check form-check-inline" style="width: 100%">
                        <input type="text" class="form-control" id="reference_value" name="reference_value" placeholder="Reference Value" autocomplete="off" value="{{old('reference_value',$edit->reference_value)}}">
                    </div>
