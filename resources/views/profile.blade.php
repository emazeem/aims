                ...
                <div class="row">
                    ...
                    <div class="col-md-8 mt-md-4">
                        ...
                        <ul class="nav nav-tabs profile-tabs nav-fill" id="myTab" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link text-reset active" id="home-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="home" aria-selected="true"><i class="feather icon-user mr-2"></i> Profile</a>
                            </li>
                        </ul>
                    </div>
                </div>
                    ...
                    <ul class="list-inline">
                        @foreach(\App\Models\User::all() as $user)
                            <li class="list-inline-item">
                                <a href="#">
                                    @if($user->profile)
                                        <img src="{{Storage::disk('local')->url('/profile/'.$user->id.'/'.$user->profile)}}" alt="user image" class="img-radius mb-2 wid-50" data-toggle="tooltip" title="{{$user->fname.' '.$user->lname}}">
                                    @else
                                        <img src="{{url('img/profile.png')}}" alt="user image" class="img-radius mb-2 wid-50" data-toggle="tooltip" title="{{$user->fname.' '.$user->lname}}">
                                    @endif
