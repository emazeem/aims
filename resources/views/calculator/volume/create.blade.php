...
@section('content')
    ...
    <div class="col-12">
        ...
        <h4><i class="fa fa-calculator"></i> Volume Calculator</h4>
    ...
    <div class="col-12">
        <form class="form-horizontal" action="{{route('volume.calculator.data.entry.store')}}" method="post">
            @csrf
                ...
                <table id="myTable" class=" table order-list">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            @if ($errors->has('y2'))
                                <span class="text-danger">
                                    <strong>{{ $errors->first('y2') }}</strong>
                                </span>
                            @endif
                        </td>
                        <td>
                            <input type="text" name="y3[]" class="form-control "/>
                            @if ($errors->has('y3'))
                                <span class="text-danger">
                                    <strong>{{ $errors->first('y3') }}</strong>
                                </span>
                            @endif
                        </td>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $("#addrow").on("click", function () {
                ...
                cols += '<td><input type="text" class="form-control" id="x1'+counter+'" name="y1[]"/></td>';
                cols += '<td><input type="text" class="form-control" id="x2'+counter+'" name="y2[]"/></td>';
                cols += '<td><input type="text" class="form-control" id="x3'+counter+'" name="y3[]"/></td>';
