...
@section('content')
    ...
    <div class="col-12">
        ...
        <h4><i class="fa fa-calculator"></i> IR Thermometer Calculator</h4>
    ...
    <div class="col-12">
        <form class="form-horizontal" action="{{route('ir.calculator.data.entry.store')}}" method="post">
            @csrf
            ...
            <div class="row cal-inputs">
                ...
                <table id="myTable" class=" table order-list">
                    <thead>
                    <tr>
                        <td>Set Value on Ref. Calibrator</td>
                        <td>X<sub>1</sub></td>
                        <td>X<sub>2</sub></td>
                        <td>X<sub>3</sub></td>
                        <td>
