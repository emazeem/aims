    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="text-right mt-2">
                <button type="button" class="btn btn-sm btn-primary shadow-sm pull-right " data-toggle="modal" data-target="#add-level"><i class="fa fa-plus-circle"></i> Add Level One</button>
