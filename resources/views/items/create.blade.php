    ...
    <div class="col-12">
        ...
        <form class="form-horizontal row" id="add-items">
            ...
            <div class="form-group col-4">
                ...
                <div class="col-12">
                    <div class="form-check form-check-inline" style="width: 100%">
                        <select class="form-control select-2-capability" style="width: 100%" id="capability"
                                name="capability">
            ...
            <div class="form-group  col-6">
                ...
                <div class="col-12">
                    <input type="text" class="form-control" id="min_range" name="range[]" placeholder="Min Range"
                           autocomplete="off">
                </div>
            </div>
            <div class="form-group  col-6">
                ...
                <div class="col-12">
                    <input type="text" class="form-control" id="max_range" name="range[]" placeholder="Max Range"
                           autocomplete="off">
                </div>
            </div>
            <div class="col-12 text-right">
                <p class="btn btn-sm check-accreditation" style="cursor: pointer">Compare Ranges</p>
            </div>
            ...
            <div class="form-group col-3">
                ...
                <div class="col-12">
                    <input type="text" class="form-control text-right" id="quantity" name="quantity"
                           placeholder="Quantity" autocomplete="off" value="{{old('quantity',1)}}">
                </div>
            </div>
