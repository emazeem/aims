        ...
        <div class="col-12">
            <form class="form-horizontal" action="{{route('invoicing_ledger.store')}}" method="post"
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-md-9" id="acc_phone_2" name="acc_phone_2" placeholder="Phone (opt.)" autocomplete="off" value="{{old('acc_phone_2',($customer->acc_phone)?$phones[1]:"")}}">
