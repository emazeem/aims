...
@section('content')
    ...
    <div class="row pb-3">
        ...
        <div class="col-12">
            <h3 class="border-bottom text-primary"><i class="fa fa-pencil"></i> Edit Invoice Ledger Details</h3>
        </div>
        {{--<div class="row">
        ...
        --}}
        <div class="col-12">
            <form class="form-horizontal" action="{{route('invoicing_ledger.update')}}" method="post"
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-md-9" id="tax_deducted_by" name="customers">
                        ...
                        @foreach($customers as $customer)
                            <option value="{{$customer->id}}" {{($edit->customer_id==$customer->id)?'selected':''}}>{{$customer->reg_name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group  row">
                    ...
                    <input type="text" class="form-control col-md-9" id="service_charges" name="service_charges"
                           placeholder="Service Charges" autocomplete="off" value="{{old('service_charges',$edit->service_charges)}}">
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-md-9" id="service_tax_type" name="service_tax_type">
                        ...
                        @foreach($service_taxes as $service_tax)
                            <option value="{{$service_tax->id}}" {{($edit->service_tax_type==$service_tax->id)?'selected':''}}>{{$service_tax->name}}</option>
                        @endforeach
                    </select>
                ...
                <div class="form-group row">
                    ...
                    <select class="form-control col-md-9" id="tax_deducted_by" name="tax_deducted_by">
                        ...
                        <option value="0" {{($edit->service_tax_deducted=='By AIMS' and  $edit->income_tax_deducted=='By AIMS')?'selected':''}}>Income Tax by AIMS + Service Tax by AIMS</option>
                        <option value="1" {{($edit->service_tax_deducted=='At Source' and  $edit->income_tax_deducted=='At Source')?'selected':''}}>Income Tax at Source + Service Tax at Source</option>
                        <option value="2" {{($edit->service_tax_deducted=='By AIMS' and  $edit->income_tax_deducted=='At Source')?'selected':''}}>Income Tax at Source + Service Tax by AIMS</option>
                    </select>
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-md-9" id="job" name="job" autocomplete="off" value="{{old('job',$edit->job_id)}}" placeholder="Job #">
                    @if ($errors->has('job'))
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-md-9" id="invoice_no" name="invoice_no" autocomplete="off" value="{{old('invoice_no',$edit->invoice_no)}}" placeholder="Invoice No">
                ...
                <div class="form-group row">
                    ...
                    <input type="date" class="form-control col-md-9" id="created_on" name="created_on" autocomplete="off" value="{{old('created_on',$edit->invoice)}}">
                ...
                <div class="form-group  row">
                    ...
                    <input type="text" class="form-control col-md-9" id="confirmed_by_name" name="confirmed_by_name"
                           placeholder="Name" autocomplete="off" value="{{old('confirmed_by_name',$edit->confirmed_by_name)}}">
                ...
                <div class="form-group row">
                    ...
                    <input type="text" class="form-control col-md-9" id="confirmed_by_phone" name="confirmed_by_phone"
                           placeholder="Phone" autocomplete="off" value="{{old('confirmed_by_phone',$edit->confirmed_by_phone)}}">
