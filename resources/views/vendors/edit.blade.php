...
@section('content')
    ...
    <div class="row pb-3">
        <div class="col-12">
            <h3 class="pull-left border-bottom pb-1"><i class="fa fa-plus-circle"></i> Edit Vendor</h3>
        ...
        <div class="col-12">
            ...
            <form class="form-horizontal" action="{{route('vendors.update')}}" method="post"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="reg_no" name="reg_no" placeholder="Reg No"
                               autocomplete="off" value="{{old('reg_no',$edit->reg_no)}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="name" name="name" placeholder="Name"
                               autocomplete="off" value="{{old('name',$edit->name)}}">
                        @if ($errors->has('name'))
                            <span class="text-danger">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="person" name="person" placeholder="Contact Person"
                               autocomplete="off" value="{{old('person',$edit->person)}}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="phone" name="phone" placeholder="Phone No"
                               autocomplete="off" value="{{old('phone',$edit->phone)}}">
                        @if ($errors->has('phone'))
                            <span class="text-danger">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="email" name="email" placeholder="Email"
                               autocomplete="off" value="{{old('email',$edit->email)}}">
                        @if ($errors->has('email'))
                            <span class="text-danger">
                    ...
                    <div class="col-sm-10">
                        <div class="form-check form-check-inline" style="width: 100%">
                            <select class="form-control" id="category" name="category">
                                ...
                                <option value="scope-1" {{$edit->category=='scope-1'?'selected':''}} >Scope # 01</option>
                                <option value="scope-2" {{$edit->category=='scope-2'?'selected':''}}>Scope # 02</option>
                                <option value="scope-3" {{$edit->category=='scope-3'?'selected':''}}>Scope # 03</option>
                            </select>
                        </div>
                        ...
                        <div class="form-check form-check-inline" style="width: 100%">
                            <select class="form-control" id="scope_of_supply" name="scope_of_supply">
                                ...
                                @foreach($scopes as $scope )
                                    <option value="{{$scope->id}}" {{$edit->scope_of_supply==$scope->id?'selected':''}}>{{$scope->title}}</option>
                                @endforeach
                            </select>
                        </div>
                    ...
                    <div class="col-sm-10">
                        <div class="form-check form-check-inline" style="width: 100%">
                            <select class="form-control" id="approval_basis" name="approval_basis">
                                ...
                                <option value="email" {{$edit->approval_basis=='email'?'selected':''}}>Email</option>
                            </select>
                        </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input type="date" class="form-control" id="expiry_date" name="expiry_date" placeholder="expiry_date"
                               autocomplete="off" value="{{old('expiry_date',$edit->expiry_date)}}">
