            ...
            <form action="{{route('emp_orientation.store')}}" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                        ...
                        <div class="form-check form-check-inline" style="width: 100%">
                            <select class="form-control" id="employee" name="employee">
                                ...
                                @foreach($employees as $employee)
                                    <option value="{{$employee->id}}">{{$employee->appraisal->fname}} {{$employee->appraisal->lname}}</option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-check form-check-inline" style="width: 100%">
                            <select class="form-control" id="orientor" name="orientor">
                                ...
                                @foreach($orientors as $orientor)
                                    <option value="{{$orientor->id}}">{{$orientor->fname}} {{$orientor->lname}}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-12 mb-1">
                        ...
                        <div class="form-check form-check-inline" style="width: 100%">
                            <textarea type="text" class="form-control" id="remarks" placeholder="Enter Remarks" name="remarks">{{old('remarks')}}</textarea>
                    ...
                    <div class="col-12">
                        ...
                        <table class="table table-bordered table-sm table-hover bg-white">
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="introduction-to-key-personnel" name="introduction-to-key-personnel">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="facility-and-operations-familiarization" name="facility-and-operations-familiarization">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="review-of-safety-regulations" name="review-of-safety-regulations">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="disciplinary-instructions" name="disciplinary-instructions">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="conduct-with-clients-and-colleagues" name="conduct-with-clients-and-colleagues">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="company-organization-chart" name="company-organization-chart">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="function-of-different-departments" name="function-of-different-departments">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="individual-responsibility-and-understanding-of-quality-policy" name="individual-responsibility-and-understanding-of-quality-policy">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="companys-quality-assurance-manual-and-AIMS-standard-or-procedures" name="companys-quality-assurance-manual-and-AIMS-standard-or-procedures">
                                    </div>
                                </td>
                                <td>
                            ...
                            <tr>
                                <td class="text-center">
                                    <div class="checkbox mt-2">
                                        <input type="checkbox" id="contractual-obligations-of-personnel" name="contractual-obligations-of-personnel">
                                    </div>
                                </td>
                                <td>
